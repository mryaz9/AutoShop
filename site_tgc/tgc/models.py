...
class MainMenu(models.Model):
    main_menu = models.CharField(max_length=250, blank=True, null=True)
    catalog = models.CharField(max_length=250, blank=True, null=True)
    ...
    info_about = models.CharField(max_length=250, blank=True, null=True)
