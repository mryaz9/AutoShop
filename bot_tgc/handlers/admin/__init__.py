...
from bot_tgc.dictionary.dictionary_ru import LEXICON_CHANGE_MENU
from bot_tgc.handlers.admin import selected
from bot_tgc.handlers.admin.states import ChangeMenu
from bot_tgc.handlers.admin.window import add_admin
from bot_tgc.handlers.admin.window import menu, add_categories
from bot_tgc.handlers.admin.window import add_item, mailing, change_menu
